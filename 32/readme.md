...
We're on the feature branch, so rebase it with master:
...
Git rebase is pretty nice for pulling in changes without creating a merge commit.  Also, remember that you will need to force push after rebasing since the commit history will have changed.